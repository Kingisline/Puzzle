...
var imagePuzzle = {
    ...
    //The timer is being started at the start of the game and will call tick method every second to update the timer.
    // Tick method is once called from the start method and then calls to itself after each second using JavaScript SetTimeout
    // recursively and update the time elapsed 
    tick: function () {
    ...
    setImage: function (images, gridSize = 4) {
        ...
        //helper is used to call the set of functions
